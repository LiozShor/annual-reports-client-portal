...
export const WA_ICON = 'https://docs.moshe-atsits.com/assets/images/whatsapp-icon.png';
...
/** Office logo URL */
export const LOGO_URL = 'https://docs.moshe-atsits.com/assets/images/logo-email.png';

...
// Load libraries by wrapping in function and executing
...
const processor = new Function(processorCode + '; return {extractSystemFields, buildAnswersTableHTML, processAllMappings, deduplicateDocuments, prepareAirtablePayload, buildActionButtonsHTML, htmlEscape};')();

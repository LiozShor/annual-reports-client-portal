...
**Date:** 2026-04-12
**Current tenant:** Moshe Atsits CPA Firm (משרד רו"ח משה עציץ)
**Client count:** 500+
...
|------|------|--------------------|----------|------------|
| `github/.../admin/index.html` | 9 | `פורטל ניהול - משרד רו"ח משה עציץ` (page title) | BRANDING | EASY |
| `github/.../admin/index.html` | 31 | `משרד רו"ח משה עציץ` (sidebar branding) | BRANDING | EASY |
| `github/.../admin/index.html` | 49 | `משרד רו״ח משה עציץ` (logo alt) | BRANDING | EASY |
...
| `github/.../index.html` | 31 | `משרד רו״ח משה עציץ` (logo alt) | BRANDING | EASY |
| `github/.../view-documents.html` | 29 | `משרד רו״ח משה עציץ` (logo alt) | BRANDING | EASY |
| `github/.../document-manager.html` | 43 | `משרד רו״ח משה עציץ` (logo alt) | BRANDING | EASY |
| `github/.../document-manager.html` | 47 | `משרד רו״ח משה עציץ` (subtitle text) | BRANDING | EASY |
| `github/.../approve-confirm.html` | 23 | `משרד רו״ח משה עציץ` (logo alt) | BRANDING | EASY |
| `github/.../privacy-policy.html` | 9,133,142 | `משרד רו״ח משה עציץ` (policy text) | BRANDING | EASY |
| `github/.../admin/js/script.js` | 7159 | `משה עציץ רו"ח` (print footer) | BRANDING | EASY |
| `github/.../assets/js/document-manager.js` | 2658 | `משה עציץ רו"ח` (print footer) | BRANDING | EASY |
| `api/src/lib/email-html.ts` | 83 | `alt="Moshe Atsits"` (email logo) | BRANDING | EASY |
| `api/src/lib/email-html.ts` | 462 | `Moshe Atsits CPA Firm / משרד רו"ח משה עציץ` (bilingual footer) | BRANDING | EASY |
| `api/src/lib/email-html.ts` | 484 | `משרד רו"ח משה עציץ` (HE-only footer) | BRANDING | EASY |
| `api/src/lib/email-html.ts` | 620 | `alt="Moshe Atsits"` (batch email logo) | BRANDING | EASY |
| `api/src/lib/email-html.ts` | 635 | `צוות משרד רו"ח משה עציץ` (sign-off) | BRANDING | EASY |
...
| `api/wrangler.toml` | 12 | `AIRTABLE_BASE_ID = "appqBL5R..."` | INFRASTRUCTURE | EASY |
...
| [06] Reminder Scheduler | Build Type A Email | code | `משה עציץ` (Hebrew firm name) | FIRM_NAME |
...
| [04] Document Edit Handler | Build Edit Email | code | `משרד רו"ח משה עציץ` (x2) | FIRM_NAME |

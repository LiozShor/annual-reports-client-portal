...
**Date:** 2026-03-29
**Audited paths:**
- Frontend: `github/annual-reports-client-portal/` (all `.html`, `.js`, `.css`, `.json`)
...
- **File:** `github/annual-reports-client-portal/view-documents.html` (lines 8, 31-32)
...
- **File:** `github/annual-reports-client-portal/assets/js/view-documents.js` (lines 281-282)
...
- **File:** `github/annual-reports-client-portal/assets/js/landing.js` (lines 20-21, 109-110)
...
- **File:** `github/annual-reports-client-portal/assets/js/landing.js` (line 32)
...
- **What:** `"הודפס מתוך מערכת ניהול דוחות שנתיים — משה עציץ רו"ח"`
...
- **File:** `github/annual-reports-client-portal/assets/js/landing.js` (lines 113-114)
...
- **File:** `github/annual-reports-client-portal/assets/js/view-documents.js` (lines 191, 257)
...
- **File:** `github/annual-reports-client-portal/privacy-policy.html` (lines 144, 152, 160)

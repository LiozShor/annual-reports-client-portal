...
| **GitHub Pages JS** | `github/annual-reports-client-portal/n8n/` — `workflow-processor-n8n.js`, `questionnaire-mapping.json`, `ssot-document-generator.js` | Web frontend (view-documents.html, document-manager.html) | Git commit + push |

...
**Last Updated:** 2026-05-01 (DL-380 follow-up — password-request email Hebrew copy made gender-neutral via passive/impersonal voice (`שנשלח אלינו` / `יש להשיב` / `נא לציין`) instead of slash-form. Live on Worker version `450e1f55-a694-4796-8206-be3b92b39389`. Verified end-to-end via admin preview modal.)

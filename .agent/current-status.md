...
**Test DL-289: Reminder "ממתין לסיווג" Card = AI Review Badge** — verify the two surfaces now show matching numbers
...
Design log: `.agent/design-logs/admin-ui/289-pending-classification-count-mismatch.md`

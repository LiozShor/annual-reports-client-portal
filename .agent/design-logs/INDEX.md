...
| # | File | Status | Summary |
|---|------|--------|---------|
| 273 | [273-fix-zero-docs-stage-stuck.md](infrastructure/273-fix-zero-docs-stage-stuck.md) | IMPLEMENTED — NEED TESTING | Fix 0-doc questionnaires stuck at Waiting_For_Answers — restructure WF02 merge node + backfill 6 reports |
